...
class Stockfish:
    ...
    def __init__(self, engine_path, default_eval_time = 0.1):
        ...
        self.limit = chess.engine.Limit(time=self.default_eval_time)
        return
    ...
    def get_best_move(self):
        result =  self.engine.play(self.board, limit = self.limit)
        logger.debug(result)
        return result.move
